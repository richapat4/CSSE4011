...
class Controller:
    ...
    def thread_plot(self,frame):
        ...
        return self.scatter, self.grid_lines
    ...
    def draw3DRectangle_once(self,x1, y1, z1, x2, y2, z2, place):
    ...
    def draw3DRectangle_update(self,x1, y1, z1, x2, y2, z2, place):
        ...
        self.grid_lines[place][2].set_data_3d([x2, x1], [y2, y2], [z1, z1])  # | (down)
        self.grid_lines[place][3].set_data_3d([x1, x1], [y2, y1], [z1, z1])  # <--

        self.grid_lines[place][4].set_data_3d([x1, x2], [y1, y1], [z2, z2])  # | (up)
        self.grid_lines[place][5].set_data_3d([x2, x2], [y1, y2], [z2, z2])  # -->
        self.grid_lines[place][6].set_data_3d([x2, x1], [y2, y2], [z2, z2])  # | (down)
        self.grid_lines[place][7].set_data_3d([x1, x1], [y2, y1], [z2, z2])  # <--

        self.grid_lines[place][8].set_data_3d([x1, x1], [y1, y1], [z1, z2])  # | (up)
        self.grid_lines[place][9].set_data_3d([x2, x2], [y2, y2], [z1, z2])  # -->
        self.grid_lines[place][10].set_data_3d([x1, x1], [y2, y2], [z1, z2])  # | (down)
        self.grid_lines[place][11].set_data_3d([x2, x2], [y1, y1], [z1, z2])  # <--
